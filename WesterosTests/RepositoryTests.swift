...
class RepositoryTests: XCTestCase {
    ...
    func testLocalRepositoryReturnsHousesBynameTypeSafe() {
        let houseName = Repository.local.house(named: "sTark")
        XCTAssertNotNil(houseName)
        XCTAssertEqual(houseName?.name, "Stark")
